...
public class E06 {
	...
	/*
	 ...
	 Run Time Exceptions: ArithmeticException, ArrayIndexOutOfBoundsException, NullPointerException
	                      NumberFormatException, IllegalArgumentException, ClassCastException
	 NOTE: You have to handle "checked exceptions" by "throwing exceptions" or by using "try-catch block"  
	       For "un-checked exceptions" if you do not type anything Java will throw exception in Run Time                     
	 */
