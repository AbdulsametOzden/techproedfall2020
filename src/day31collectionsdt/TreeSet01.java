...
public class TreeSet01 {
	...
	*/
	...
	public static void main(String[] args) {
		...
		System.out.println("TreeSet time: " + (endingTime1 - startingTime1));//2 milliseconds
		...
		System.out.println("HashSet + TreeSet time: " + (endingTime2 - startingTime2));//0 milliseconds
